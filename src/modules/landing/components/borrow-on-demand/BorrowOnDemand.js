...
const BorrowOnDemand = ({ newTokenData, viewMoreToggle, onViewMoreClick }) => {
  ...
  return (
    <section
      ref={myRef}
      className="earninterest-section-container borrow-on-demand-container"
      id="borrow-on-demand-container"
    >
      <div className="half-yellow-vector-wrapper">
        <img
          src={HalfYellowVector}
          alt="yellow vector"
          className="half-yellow-vector"
        />
      </div>
          ...
          description: (
            <>
              <div className="description-content">
                Use your fToken collateral to borrow from the Fortress Protocol
                instantly with no trading fees, no slippage and directly
                on-chain. With Fortress, you have on-demand liquidity available
                globally.
              </div>
                      ...
                      <div className="token-wrapper">
                        ...
                        <div className="apy-details">
                          <div className="apy-perc">
                            ${addComma(numbersAfterDecimal(token.liquidity))}
                          </div>
